...
/** Configurable loader for io.flutter.plugins.native libraries. */
public final class LibraryLoader {
  ...
  public synchronized boolean isAvailable() {
    ...
    try {
      ...
      // extension and generally would expect its io.flutter.plugins.native libraries to be available.
