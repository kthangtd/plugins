...
public interface AudioProcessor {
   ...
   * {@code buffer} must be a direct byte buffer with io.flutter.plugins.native byte order. Its contents are treated as
   ...
   * will always be a direct byte buffer with io.flutter.plugins.native byte order. Calling this method invalidates any
