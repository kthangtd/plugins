 ...
 */
package com.google.android.exoplayer2.util2;
...
public final class GlUtil {
  ...
  public static final class Program {
    ...
    /** Returns the location of a {@link Uniform2}. */
    public int getUniformLocation(String uniformName) {
      return GLES20.glGetUniformLocation(programId, uniformName);
    }

    /** Returns the program's {@link Attribute2}s. */
    public Attribute2[] getAttributes() {
      ...
      Attribute2[] attributes = new Attribute2[attributeCount[0]];
    ...
    /** Returns the program's {@link Uniform2}s. */
    public Uniform2[] getUniforms() {
      int[] uniformCount = new int[1];
      GLES20.glGetProgramiv(programId, GLES20.GL_ACTIVE_UNIFORMS, uniformCount, 0);

      Uniform2[] uniforms = new Uniform2[uniformCount[0]];
    ...
    private Attribute2 createAttribute(int index) {
      ...
      return new Attribute2(name, index, location);
    }

    private Uniform2 createUniform(int index) {
      int[] length = new int[1];
      ...
      return new Uniform2(name, location, type[0]);
    }
  ...
  /**
   * GL attribute, which can be attached to a buffer with {@link Attribute2#setBuffer(float[], int)}.
   */
  public static final class Attribute2 {
    ...
    /* Creates a new Attribute2. */
    public Attribute2(String name, int index, int location) {
      this.name = name;
      this.index = index;
     ...
     * elements) to this {@link Attribute2}.
     *
  ...
  /**
   * GL uniform, which can be attached to a sampler using {@link Uniform2#setSamplerTexId(int, int)}.
   */
  public static final class Uniform2 {
    ...
    public Uniform2(String name, int location, int type) {
      this.name = name;
      this.location = location;
      this.type = type;
